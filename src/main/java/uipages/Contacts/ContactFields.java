...
public class ContactFields {
    ...
    public static String addNewContactTitle(){return "Add a new contact";}
    public static String addFromAddressBook(){return "Address book";}
    public static String addByEmail(){return "Email";}

    public static String addContactFirstName(){return "addContactFirstName";}
    public static String addContactLastName(){return "addContactLastName";}
    public static String addContactEmail(){return "addContactEmail";}
